...
func valid(from, to command.Status) bool {
	...
	case command.StatusDispatching:
		return to == command.StatusQueued || to == command.StatusDispatched || to == command.StatusAccepted || to == command.StatusSucceeded || to == command.StatusFailed || to == command.StatusTimedOut || to == command.StatusCanceled || to == command.StatusInterrupted
